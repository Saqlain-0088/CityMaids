      ...
      <div className="container-xl">
        ...
        >
          ...
          <div className="relative px-8 py-16 sm:px-14 sm:py-20 max-w-2xl w-full">
            ...
            >
              <span className="inline-flex items-center gap-2 bg-brand-500/20 border border-brand-500/30 text-brand-300 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
              ...
              <p className="text-slate-300 text-lg mb-3">
                Book today and get <span className="text-white font-bold">15% off</span> your first cleaning.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-8">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#25D366]/20 border border-[#25D366]/40 text-white font-semibold rounded-xl px-8 py-4 text-base transition-all duration-200 hover:bg-[#25D366]"
                >
