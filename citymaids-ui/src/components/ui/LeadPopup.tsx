  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-up">
        <div className="bg-gradient-to-br from-brand-600 to-brand-700 px-7 pt-7 pb-10 text-center relative">
          ...
          <h3 className="text-2xl font-extrabold text-white mb-1" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>Get $20 Off</h3>
          <p className="text-brand-100 text-sm">Your first cleaning service</p>
        </div>
            ...
            <>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all"
                />
                <button
                  onClick={submit}
                  className="bg-brand-600 text-white font-semibold px-5 py-3 rounded-xl hover:bg-brand-700 transition-colors text-sm whitespace-nowrap"
                >
                  Claim
                </button>
              </div>
