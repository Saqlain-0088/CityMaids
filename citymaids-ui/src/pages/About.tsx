...
function Stat({ value, suffix, label, inView }: { value: number; suffix: string; label: string; inView: boolean }) {
  ...
  return (
    <div className="text-center p-6 bg-brand-50 rounded-2xl">
      <p className="text-4xl font-extrabold text-brand-700" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>{count.toLocaleString()}{suffix}</p>
    ...
    <MainLayout>
      <div className="bg-gradient-to-br from-dark-900 to-dark-800 py-16">
        <div className="container-xl text-center">
          <span className="inline-block text-brand-400 font-semibold text-sm uppercase tracking-widest mb-3">Our Story</span>
          ...
          <p className="text-dark-300 text-lg max-w-2xl mx-auto">We're on a mission to make professional home cleaning accessible, reliable, and stress-free for everyone.</p>
        </div>
      </div>
      ...
      <section className="section bg-white">
        <div className="container-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              <span className="section-tag"><span className="w-5 h-0.5 bg-brand-500 rounded" />Our Story</span>
              <h2 className="section-title mb-5">Built on Trust, <span className="text-gradient">Driven by Quality</span></h2>
              <p className="text-dark-500 leading-relaxed mb-4">CityMaids was founded in 2020 with a simple idea: everyone deserves a clean home, and finding a reliable cleaner shouldn't be a hassle.</p>
              <p className="text-dark-500 leading-relaxed mb-4">We started with a small team of 5 cleaners in Manhattan and have grown to serve over 5,000 customers across New York City and surrounding areas.</p>
              <p className="text-dark-500 leading-relaxed mb-8">Today, our platform connects hundreds of vetted cleaning professionals with homeowners who value their time and their home.</p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 bg-brand-600 text-white rounded-2xl p-5 shadow-brand text-center hidden md:block">
      ...
      <section className="section bg-white">
        <div className="container-xl">
          <div className="text-center mb-14">
            <span className="section-tag"><span className="w-5 h-0.5 bg-brand-500 rounded" />What We Stand For</span>
