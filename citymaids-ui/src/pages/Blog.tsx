    ...
    <MainLayout>
      <div className="bg-gradient-to-br from-dark-900 to-dark-800 py-16">
        <div className="container-xl text-center">
          <span className="inline-block text-brand-400 font-semibold text-sm uppercase tracking-widest mb-3">Our Blog</span>
          ...
          <p className="text-dark-300 text-lg max-w-xl mx-auto">Expert advice for a cleaner, healthier home.</p>
        </div>
      </div>
            ...
            {posts.map((post, i) => (
              <article key={post.id}
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-bold text-dark-900 text-xl leading-snug mb-2 group-hover:text-brand-700 transition-colors">{post.title}</h3>
                  <p className="text-dark-500 text-sm leading-relaxed mb-3 line-clamp-2">{post.excerpt}</p>
