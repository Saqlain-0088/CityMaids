        ...
        <div className='container-xl max-w-6xl'>
          <div className='grid grid-cols-1 lg:grid-cols-5 gap-12'>
            <div className='lg:col-span-2 space-y-6'>
              ...
              {[{ icon: 'Ã°Å¸â€œÂ', title: 'Our Office', value: '123 Clean Street, New York, NY 10001', sub: 'MonÃ¢â‚¬â€œFri: 8AMÃ¢â‚¬â€œ8PM' }, { icon: 'Ã°Å¸â€œÅ¾', title: 'Phone', value: '+1 (555) 000-1234', sub: 'Available 7 days a week' }, { icon: 'Ã¢Å“â€°Ã¯Â¸Â', title: 'Email', value: 'hello@citymaids.com', sub: 'We reply within 2 hours' }, { icon: 'Ã°Å¸â€™Â¬', title: 'WhatsApp', value: '+1 (555) 000-1234', sub: 'Instant response' }].map(item => (
              ...
              <div className='bg-slate-100 rounded-2xl overflow-hidden h-48'>
                <div className='w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-200 to-slate-300'>
                  <div className='text-center'><p className='text-4xl mb-2'>Ã°Å¸â€œÂ</p><p className='text-slate-600 font-semibold text-sm'>123 Clean Street, New York</p><p className='text-slate-400 text-xs'>Google Maps</p></div>
                </div>
              </div>
            </div>
