    ...
    <AdminLayout>
      <div className='flex flex-col items-center justify-center min-h-[60vh] text-center'>
        <div className='w-16 h-16 rounded-2xl bg-primary-50 flex items-center justify-center mb-4'>
          <span className='text-3xl'>Ã¢Ââ€œ</span>
        </div>
        <h2 className='text-2xl font-extrabold text-slate-900 mb-2'>FAQ</h2>
        <p className='text-slate-500 text-sm max-w-sm'>Add, edit, and reorder frequently asked questions.</p>
