  ...
  return (
    <AdminLayout>
      <div className='flex flex-col items-center justify-center min-h-[60vh] text-center'>
        ...
        <h2 className='text-2xl font-extrabold text-slate-900 mb-2'>Home Page</h2>
        <p className='text-slate-500 text-sm max-w-sm'>Manage hero section, features, and homepage content.</p>
