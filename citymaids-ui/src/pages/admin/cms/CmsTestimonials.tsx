  ...
  return (
    <AdminLayout>
      <div className='flex flex-col items-center justify-center min-h-[60vh] text-center'>
        ...
        <h2 className='text-2xl font-extrabold text-slate-900 mb-2'>Testimonials</h2>
        <p className='text-slate-500 text-sm max-w-sm'>Manage customer testimonials shown on the site.</p>
